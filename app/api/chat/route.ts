...
◎ 거리 추가 요금
  - 20km 이내: 추가 비용 없음 (기본 단가 그대로)
  - 20km 초과 시 거리가 10km 추가될 때마다 1톤당 +10만원
    예) 30km 이전 → 20km 초과 10km, 톤당 +10만원
        40km 이전 → 20km 초과 20km, 톤당 +20만원
        50km 이전 → 20km 초과 30km, 톤당 +30만원
  - 거리는 출발지~도착지 기준, 10km 단위로 올림 계산

◎ 예시 견적 계산 (참고용 — 정확한 금액은 현장 조사 후 확정)
  - "사무실 5톤 이사, 출발-도착 25km":
      기본 5톤 × 30만원 = 150만원
      거리: 25km는 20km 초과 5km → 10km 1구간 적용 → 5톤 × 10만원 = 50만원
      합계: 약 200만원 (사전포장 기준, 부가세 별도)
  - "공장 10톤 이사, 50km":
      기본 10톤 × 30만원 = 300만원
      거리 추가: 50km - 20km = 30km → 3구간 × 10만원 × 10톤 = 300만원
      합계: 약 600만원 (사전포장 기준, 부가세 별도)
...
- 거리·톤수 견적 질문(예: "강남에서 분당까지 5톤 얼마?")이 들어오면:
  (1) 위 [거리 추가 요금] 룰로 직접 계산해서 대략 금액을 알려준다.
  (2) 사전포장(30만원/톤) vs 풀패키지(40만원/톤) 두 가지 모두 계산해 비교 제시 권장.
  (3) 계단/사다리차 가능성도 짚어주고, "정확한 금액은 무료 현장 조사 후 확정 — ${c.phonePrimary}로 전화 주세요"로 마무리.
  (4) 거리를 알려주지 않으면 출발지·도착지를 다시 물어본다.
