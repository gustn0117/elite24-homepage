...
const VALUES = [
  {
    ...
    kr: "기업이사 전문성",
    desc:
      "법인·사업장 이전 경험을 바탕으로 까다로운 작업 환경에 가장 최적화된 솔루션을 제공합니다. 가정이사는 진행하지 않으며 오직 기업이사에 집중합니다.",
  },
  {
    no: "02",
    title: "Transparency",
    kr: "투명한 견적",
    desc:
      "현장 조사를 통해 산정된 명확한 견적을 안내하며, 추가 비용은 사전에 모두 공유합니다. 이사 당일에 발생하는 불필요한 갈등을 원천적으로 차단합니다.",
  },
  {
    no: "03",
    ...
    kr: "책임 있는 작업",
    desc:
      "포장부터 운반·정리까지 한 팀이 일관되게 진행합니다. 책임 소재가 분명하고, 대표자가 직접 상담과 작업에 참여해 끝까지 챙깁니다.",
  },
];
  ...
  return (
    <>
      ...
      <section className="section bg-white">
        <div className="container-pad grid lg:grid-cols-12 gap-14 lg:gap-20 items-start">
          <div className="lg:col-span-5">
            <span className="eyebrow">Who we are</span>
            <h2 className="mt-6 section-title-serif text-balance">
              기업의 이전, 한 곳에 책임을 둡니다.
            </h2>
            <div className="mt-10 relative aspect-[4/5] overflow-hidden border border-navy-200/70">
              <img
                src={IMG.workspace}
                alt="기업 업무 환경"
                className="image-cover"
              />
              <div className="absolute inset-x-0 bottom-0 h-2/3 photo-veil-soft" />
          ...
          <div className="lg:col-span-7 lg:pt-4">
            <p className="text-[16px] sm:text-lg leading-[2] text-navy-700 text-pretty">
            ...
            <p className="mt-6 text-[15px] leading-[1.95] text-navy-600 text-pretty">
              포장재·차량·인력을 자체 운용하며, 대표가 상담과 작업 현장을 직접
              챙기기 때문에 결정과 책임이 한 곳에서 이루어집니다. 그 결과
              약속된 일정과 견적 안에서, 안정된 작업 품질을 유지할 수 있습니다.
            </p>

            <div className="mt-12 grid sm:grid-cols-3 gap-px bg-navy-200/50 border border-navy-200/50">
              {[
                { v: "100%", l: "Corporate Only" },
                { v: "1ON1", l: "Direct Care" },
                { v: "365", l: "Days a Year" },
              ].map((s) => (
                <div key={s.l} className="bg-white px-6 py-7">
                  <div className="font-serif text-3xl leading-[1.1] text-brand-navy">
                    {s.v}
                  </div>
                  <div className="mt-3 text-[10px] leading-none tracking-wider2 uppercase text-navy-500 font-semibold">
                    {s.l}
                  </div>
                </div>
              ))}
      ...
      <section className="section bg-cream relative overflow-hidden">
        <div className="container-pad grid lg:grid-cols-12 gap-14 items-center">
          <div className="lg:col-span-5 order-2 lg:order-1">
            ...
            <h2 className="mt-6 font-serif text-4xl sm:text-5xl leading-[1.15] font-medium text-brand-navy text-balance">
              대표 인사말
            </h2>
            ...
            <p className="mt-5 text-[15.5px] leading-[2] text-navy-700 text-pretty">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <div className="relative">
              <div className="absolute -top-6 -left-6 w-32 h-32 border border-brand-gold/30 hidden sm:block" />
              <div className="absolute -bottom-6 -right-6 w-40 h-40 border border-brand-gold/15 hidden sm:block" />

              <div className="relative grid grid-cols-12 gap-3">
                <div className="col-span-7 relative aspect-[4/3] overflow-hidden border border-navy-200/60">
            ...
            {VALUES.map((v) => (
              <div key={v.no} className="bg-white p-9 lg:p-11">
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-[10px] leading-none tracking-eyebrow uppercase text-navy-400">
                    {v.title}
                  </span>
                </div>
                <h3 className="mt-12 text-2xl leading-[1.3] font-semibold tracking-tight text-brand-navy">
                  {v.kr}
                </h3>
                <span className="block mt-5 w-10 h-px bg-brand-gold" />
                <p className="mt-5 text-[14.5px] leading-[1.95] text-navy-600 text-pretty">
                  {v.desc}
                </p>
              </div>
            ))}
      ...
      {/* Company info */}
      <section className="relative section-tight bg-brand-navyDeep text-white overflow-hidden grain">
        <img
          src={IMG.heroSkyline}
          alt=""
          aria-hidden
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-brand-navyDeep/85 to-brand-navyDeep" />
        <div
        ...
        <div className="container-pad relative">
          <div className="grid lg:grid-cols-12 gap-10 items-end mb-12">
            <div className="lg:col-span-7">
              ...
              <h2 className="mt-6 font-serif text-4xl sm:text-5xl leading-[1.15] font-medium text-white text-balance">
                사업자 정보
              </h2>
            </div>
          ...
          <ul className="border-t border-white/15">
            {COMPANY_INFO.map((c) => (
              ...
              >
                <div className="col-span-4 sm:col-span-3 text-[11px] leading-[1.6] tracking-wider2 uppercase text-brand-goldLight font-semibold pt-1">
                  {c.label}
                </div>
                <div className="col-span-8 sm:col-span-9 text-white">
                  {c.value}
                </div>
              </li>
            ))}
