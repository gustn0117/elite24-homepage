...
export default function About() {
  return (
    <>
        ...
        <div className="container-pad grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6">
            ...
            <div className="mt-8 grid sm:grid-cols-3 gap-3">
              {[
                { v: "100%", l: "기업이사 전문", bg: "bg-amber-50" },
                { v: "1ON1", l: "대표 직접 상담", bg: "bg-sky-50" },
                { v: "365일", l: "주말·야간 가능", bg: "bg-emerald-50" },
              ].map((s) => (
                <div key={s.l} className={`rounded-2xl ${s.bg} px-5 py-5`}>
          ...
          <div className="lg:col-span-6">
            <div className="relative aspect-square max-w-md mx-auto bg-gradient-to-br from-amber-50 to-sky-50 rounded-3xl">
        ...
        <div className="container-pad">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-5">
            {VALUES.map((v, i) => (
              <div
                key={v.title}
                className={`${v.bg} rounded-2xl p-7 hover:shadow-card hover:-translate-y-1 transition border border-transparent hover:border-navy-100 animate-fade-up`}
      ...
      <section className="section bg-white">
        <div className="container-pad">
          <div className="relative max-w-4xl mx-auto bg-gradient-to-br from-brand-orange to-brand-orangeDark text-white rounded-3xl p-8 sm:p-12 lg:p-14 overflow-hidden shadow-glow">
            <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-white/15 blur-3xl animate-pulse-soft" aria-hidden />
            <div className="absolute -bottom-20 -left-20 w-56 h-56 rounded-full bg-white/10 blur-3xl animate-float-slow" aria-hidden />

            <div className="relative">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/20 backdrop-blur border border-white/30 px-3 py-1 text-[11px] tracking-wider2 uppercase font-bold">
                대표 인사말
              </span>
              ...
              <div className="mt-6 max-w-2xl">
                <p className="text-[15.5px] leading-[1.95] text-white/95 text-pretty">
                  저희 (주)엘리트24를 찾아주신 모든 기업 고객 여러분께 진심으로
                  감사드립니다. 사무실·공장·창고 이전 현장에서 쌓아온 경험을 바탕으로,
                  기업 고객이 가장 중요하게 여기는{" "}
                  <strong>시간·비용·자산의 안전</strong>을 지키는 데 모든 자원을 집중하고 있습니다.
                </p>
                <p className="mt-4 text-[15px] leading-[1.95] text-white/85 text-pretty">
                  기업의 새로운 출발을 함께 만들 수 있도록, 정직한 견적과 책임감
                  있는 작업으로 보답드리겠습니다.
                </p>
              </div>

              <div className="mt-7 inline-flex items-center gap-3 rounded-full bg-white/20 backdrop-blur border border-white/30 px-5 py-3">
                <div className="text-[11px] tracking-wider2 uppercase font-bold">CEO</div>
