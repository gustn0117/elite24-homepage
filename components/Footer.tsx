        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            ...
            <div className="mt-7 flex items-center gap-3">
              <a href="tel:01039566618" className="btn-primary">상담 전화</a>
          ...
          <div className="lg:col-span-4">
            ...
            <ul className="mt-5 space-y-3 text-[14px]">
              <li className="flex justify-between border-b border-navy-100 pb-3">
                <span className="text-navy-500">대표 연락처</span>
                <a href="tel:01039566618" className="text-brand-navy font-bold hover:text-brand-orange">010-3956-6618</a>
              </li>
              <li className="flex justify-between border-b border-navy-100 pb-3">
                <span className="text-navy-500">사무실</span>
                <a href="tel:0269588067" className="text-brand-navy font-bold hover:text-brand-orange">02-6958-8067</a>
              </li>
              <li className="flex justify-between border-b border-navy-100 pb-3">
                <span className="text-navy-500">이메일</span>
                <a href="mailto:pirseng0825@naver.com" className="text-brand-navy font-bold hover:text-brand-orange text-[13px]">pirseng0825@naver.com</a>
              </li>
              <li className="flex justify-between border-b border-navy-100 pb-3">
                <span className="text-navy-500">대표</span>
                <span className="text-brand-navy font-bold">황필성</span>
              </li>
              <li className="flex justify-between">
                <span className="text-navy-500">주소</span>
                <span className="text-brand-navy font-bold text-right">서울 금천구 독산로 106길 15</span>
              </li>
            </ul>
          </div>
        </div>
